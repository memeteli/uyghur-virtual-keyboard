...
!(function (t, e) {
  ...
  return (function (t) {
    ...
    function __webpack_require__(n) {
      ...
      return (
        t[n].call(o.exports, o, o.exports, __webpack_require__),
        (o.l = !0),
        o.exports
      );
    }
              ...
              },
              {
                ...
                value: function (t, e, n) {
                  var o =
                    ...
                    r = e;
                  return (
                    ("{bksp}" === t || "{backspace}" === t) && r.length > 0
                      ? (r = this.removeAt.apply(this, [r].concat(a)))
                      : "{space}" === t
                      ? (r = this.addStringAt.apply(this, [r, " "].concat(a)))
                      : "{tab}" !== t ||
                        ("boolean" === typeof s.tabCharOnTab &&
                          !1 === s.tabCharOnTab)
                      ? ("{enter}" !== t && "{numpadenter}" !== t) ||
                        !s.newLineOnEnter
                        ? t.includes("numpad") &&
                          Number.isInteger(Number(t[t.length - 2]))
                          ? (r = this.addStringAt.apply(
                              this,
                              [r, t[t.length - 2]].concat(a)
                            ))
                          : "{numpaddivide}" === t
                          ? (r = this.addStringAt.apply(
                              this,
                          ...
                          : "{" === t || "}" === t
                          ? (r = this.addStringAt.apply(this, [r, t].concat(a)))
                          : t.includes("{") ||
                            t.includes("}") ||
                            (r = this.addStringAt.apply(this, [r, t].concat(a)))
                        : (r = this.addStringAt.apply(
                    ...
                    o || 0 === o
                      ? ((n = [t.slice(0, o), e, t.slice(i)].join("")),
                        this.isMaxLengthReached() ||
                          (s && this.updateCaretPos(e.length)))
                      : (n = t + e),
                    n
                  );
                },
      ...
      var u = (function () {
        function PhysicalKeyboard(t) {
          ...
          !(function (t, e) {
            ...
            (this.dispatch = e),
            (this.getOptions = n),
            r.bindMethods(PhysicalKeyboard, this);
        }
        var t, e, n;
        return (
          (t = PhysicalKeyboard),
          ...
          ]) && PhysicalKeyboard_defineProperties(t.prototype, e),
          n && PhysicalKeyboard_defineProperties(t, n),
          PhysicalKeyboard
        );
      })();
        ...
        return (
          ...
          (function (t, e) {
            ...
            if (
              ...
              return Keyboard_arrayLikeToArray(t, e);
          })(t) ||
          (function () {
            throw new TypeError(
      ...
      var c = (function () {
        function SimpleKeyboard() {
          ...
          Keyboard_classCallCheck(this, SimpleKeyboard),
            Keyboard_defineProperty(this, "handleParams", function (t) {
              var e, n, o;
          ...
          if (
            ...
            r.bindMethods(SimpleKeyboard, this),
            (this.input = {}),
            (this.input[this.options.inputName] = ""),
            (this.keyboardDOMClass = s),
            (this.buttonElements = {}),
            ...
            throw (
              (console.warn('".'.concat(s, '" was not found in the DOM.')),
        ...
        return (
          ...
          (e = [
              ...
              value: function (t) {
                ...
                if (
                  ...
                  (!this.options.inputPattern ||
                    (this.options.inputPattern && this.inputPatternIsValid(n)))
                ) {
                  if (
                  ...
                  (this.input[
                    ...
                    e && console.log("Input changed:", this.getAllInputs()),
                    this.options.debug &&
                      console.log(
                        "Caret at: ",
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                this.options.preventMouseDownDefault && e.preventDefault(),
                  ...
                  e && e.target.classList.add(this.activeButtonClass),
            ...
            },
            {
              ...
              value: function (t, e) {
                var n = this;
                if (!t && !e)
                  return (this.options.buttonTheme = []), this.render(), !1;
                t &&
                  ...
                  (t.split(" ").forEach(function (t) {
                    n.options.buttonTheme.map(function (o, i) {
                      if ((e && e.includes(o.class)) || !e) {
                        ...
                        s.length
                          ? (o.buttons = s.join(" "))
                          : (n.options.buttonTheme.splice(i, 1), (o = null));
                      }
                      return o;
                    });
                  }),
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if (
                  (e = n instanceof RegExp ? n : n[this.options.inputName]) &&
                  t
                ) {
                  var o = e.test(t);
                  return (
                ...
                (this.keyboardDOM.className = this.getKeyboardClassString(
                  ...
                  n[this.options.layoutName].forEach(function (e, n) {
                    ...
                    i.forEach(function (e, i) {
                      ...
                      h && (u.push(i), (e = e.replace(/\[/g, ""))),
                        d && (c.push(i), (e = e.replace(/\]/g, "")));
                      var p = t.utilities.getButtonClass(e),
                        f = t.utilities.getButtonDisplayName(
                          e,
                          t.options.display,
                      ...
                      (b.className += "hg-button ".concat(p)),
                        (l = b.classList).add.apply(
                          l,
                          _toConsumableArray(t.getButtonThemeClasses(e))
                        ),
                        t.setDOMButtonAttributes(e, function (t, e) {
                          b.setAttribute(t, e);
                        }),
                        (t.activeButtonClass = "hg-activeButton"),
                        !t.utilities.pointerEventsSupported() || o || s
                          ? o
                            ? ((b.ontouchstart = function (n) {
                                t.handleButtonClicked(e),
                      ...
                      (g.innerHTML = f),
                        ...
                        t.buttonElements[e].push(b),
                        r.appendChild(b);
                    }),
                      (r = t.parseRowDOMContainers(r, n, u, c)),
                      t.keyboardDOM.appendChild(r);
                  }),
                  this.onRender(),
                  this.initialized ||
                    ((this.initialized = !0),
                    !this.utilities.pointerEventsSupported() || o || s
                      ? o
          ...
          ]) && Keyboard_defineProperties(t.prototype, e),
          n && Keyboard_defineProperties(t, n),
          SimpleKeyboard
        );
      })();
      e.default = c;
